...
class DataBase:
    ...
    @staticmethod
    def select_all_pending_source_code_with_duplicates() -> typing.List[typing.Type[PendingSourceCodeWithDuplicates]] | None:
        with (create_session() as session):
            source_code: typing.List[typing.Type[SourceCodeSmell]] | None = session.query(PendingSourceCodeWithDuplicates).all()
            if source_code:
                return source_code
            return None
